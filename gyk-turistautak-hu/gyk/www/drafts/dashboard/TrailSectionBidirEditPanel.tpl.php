<?php
	// This is the HTML template include file (.tpl.php) for trail_section_bidirEditPanel.
...
?>
	<div id="formControls">
		...
		<?php $_CONTROL->lstRevTrailSection->RenderWithName(); ?>

		<?php $_CONTROL->lstAbsTrailSection->RenderWithName(); ?>

		<?php $_CONTROL->lstTrailSectionStat->RenderWithName(); ?>
