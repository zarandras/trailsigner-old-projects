<?php
	// This is the HTML template include file (.tpl.php) for the tmp_trail_backup_edit.php
	// form DRAFT page.  Remember that this is a DRAFT.  It is MEANT to be altered/modified.

	// Be sure to move this out of the generated/ subdirectory before modifying to ensure that subsequent 
	// code re-generations do not overwrite your changes.

	$strPageTitle = QApplication::Translate('TmpTrailBackup') . ' - ' . $this->mctTmpTrailBackup->TitleVerb;
...
?>
	...
	<div id="titleBar">
		<h2><?php _p($this->mctTmpTrailBackup->TitleVerb); ?></h2>
		<h1><?php _t('TmpTrailBackup')?></h1>
	</div>
