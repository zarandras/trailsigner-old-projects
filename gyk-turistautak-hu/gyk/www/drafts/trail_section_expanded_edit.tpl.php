<?php
	// This is the HTML template include file (.tpl.php) for the trail_section_expanded_edit.php
	// form DRAFT page.  Remember that this is a DRAFT.  It is MEANT to be altered/modified.

	// Be sure to move this out of the generated/ subdirectory before modifying to ensure that subsequent 
	// code re-generations do not overwrite your changes.

	$strPageTitle = QApplication::Translate('TrailSectionExpanded') . ' - ' . $this->mctTrailSectionExpanded->TitleVerb;
...
?>
	...
	<div id="titleBar">
		<h2><?php _p($this->mctTrailSectionExpanded->TitleVerb); ?></h2>
		<h1><?php _t('TrailSectionExpanded')?></h1>
	</div>

	<div id="formControls">
		<?php $this->lstTrailSection->RenderWithName(); ?>

		<?php $this->lstTrailNode->RenderWithName(); ?>

		<?php $this->lstTrail->RenderWithName(); ?>

		<?php $this->txtNodeIdx->RenderWithName(); ?>

		<?php $this->txtBranchId->RenderWithName(); ?>

		<?php $this->txtNoiId->RenderWithName(); ?>
		...
		<?php $this->chkDefinedAsFirst->RenderWithName(); ?>

		<?php $this->chkDefinedAsLast->RenderWithName(); ?>

		<?php $this->txtUseBranchDir->RenderWithName(); ?>
